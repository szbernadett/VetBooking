...
public class CreateObjects {
    ...
    public static void main(String[] args) {
        ...
        String medicalHistory = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, "
                + "sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ";

        Record rec1 = new Record(LocalDate.of(2024, 3, 15), pet1, medicalHistory, new ArrayList<>());
        Record rec2 = new Record(LocalDate.of(2024, 3, 15), pet2, medicalHistory, new ArrayList<>());
        Record rec3 = new Record(LocalDate.of(2024, 3, 18), pet3, medicalHistory, new ArrayList<>());
        Record rec4 = new Record(LocalDate.of(2024, 3, 18), fan1, medicalHistory, new ArrayList<>());
        Record rec5 = new Record(LocalDate.of(2024, 3, 19), fan2, medicalHistory, new ArrayList<>());
        Record rec6 = new Record(LocalDate.of(2024, 3, 19), fan3, medicalHistory, new ArrayList<>());
        Record rec7 = new Record(LocalDate.of(2024, 3, 20), zan1, medicalHistory, new ArrayList<>());
        Record rec8 = new Record(LocalDate.of(2024, 3, 20), zan2, medicalHistory, new ArrayList<>());
        Record rec9 = new Record(LocalDate.of(2024, 3, 21), zan3, medicalHistory, new ArrayList<>());
        Record rec10 = new Record(LocalDate.of(2024, 3, 21), zan4, medicalHistory, new ArrayList<>());
        Record rec11 = new Record(LocalDate.of(2024, 3, 21), zan5, medicalHistory, new ArrayList<>());
